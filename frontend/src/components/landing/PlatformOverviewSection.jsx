function PlatformOverviewSection({ modules, steps }) {
  return (
    <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
      <div
        id="platform"
        className="scroll-mt-24 rounded-3xl border border-[#dbe4db] bg-[linear-gradient(180deg,#ffffff_0%,#f7faf6_100%)] p-5 sm:p-8 shadow-[0_18px_40px_rgba(15,23,42,0.06)]"
      >
        <div>
      ...
      <div
        id="workflow"
        className="scroll-mt-24 rounded-3xl border border-[#d6e2d8] bg-[linear-gradient(135deg,#214f39_0%,#184d35_42%,#102d1d_100%)] p-5 sm:p-8 text-white shadow-[0_24px_60px_rgba(24,77,53,0.16)]"
      >
