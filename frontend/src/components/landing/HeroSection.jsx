...
function FloatingIconCard({
  ...
  return (
    <div className={`absolute z-10 ${wrapperClassName}`}>
      ...
      >
        <div className="absolute inset-0 rounded-[24px] bg-[radial-gradient(circle_at_top,rgba(52,211,153,0.2),transparent_60%)] opacity-0 blur-sm transition duration-500 group-hover:opacity-100" />
        <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[#05100c]/75 p-1.5 shadow-xl shadow-black/30 backdrop-blur transition duration-500 group-hover:-translate-y-3 group-hover:scale-105 group-hover:border-emerald-300/45 group-hover:bg-[#0a1712]/90 group-hover:shadow-[0_22px_55px_rgba(16,185,129,0.24)] sm:p-2">
          <div className="relative rounded-[18px] border border-emerald-300/10 bg-emerald-400/8 p-2 sm:p-2.5">
            <div className="absolute inset-x-3 top-2 h-7 rounded-full bg-emerald-300/12 blur-lg opacity-0 transition duration-500 group-hover:opacity-100" />
            <img
              src={image}
              alt={alt}
        ...
        <div className="pointer-events-none absolute left-1/2 top-full mt-3 -translate-x-1/2 translate-y-1 rounded-full border border-emerald-300/20 bg-[#07130d]/95 px-3 py-1 text-[10px] uppercase tracking-[0.2em] text-emerald-300 opacity-0 transition duration-300 group-hover:translate-y-0 group-hover:opacity-100">
          {label}
        </div>
      </div>
    </div>
...
function HeroSection({ stats }) {
  return (
    <section
      id="home"
      className="rounded-[32px] border border-emerald-400/10 bg-gradient-to-br from-emerald-950 via-[#08160f] to-[#07130d] p-8 shadow-2xl shadow-emerald-900/20 lg:p-10"
    >
      <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.2em] text-emerald-300">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-xl">
            <div className="absolute inset-x-10 bottom-8 h-24 rounded-full bg-emerald-400/15 blur-3xl sm:bottom-10" />
